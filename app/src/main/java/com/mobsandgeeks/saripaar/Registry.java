...
/**
 * Maintains a registry of all {@link View}s and
...
final class Registry {
    ...
    /**
     * This is a convenience method for Annotations that operate on {@link TextView}
     ...
     * {@link String}s, {@link Integer}s, {@link Float}s and
     * {@link Double} values.
     *
     * @param ruleAnnotations  Varargs of rule {@link Annotation}s that operate
     *      on {@link TextView}s.
     */
     ...
     * {@link AnnotationRule}s and their {@link View}s.
     *
     * @param viewType  The {@link View} type on which the {@link AnnotationRule}
     *      can be used.
     ...
     *      {@link View}.
     * @param ruleAnnotations  Varargs of rule {@link Annotation}s that
     *      can be used with the {@link View} and the
     *      {@link com.mobsandgeeks.saripaar.adapter.ViewDataAdapter}.
     *
     * @param <VIEW>  Type parameter that is a subclass of {@link View} class.
     ...
     *
     * @return {@link Set} containing all registered rule
     *      {@link Annotation}s.
     */
     ...
     * with the rule {@link Annotation} and
     * {@link View}. If no registered adapter is not found, the method looks for a
     * compatible adapter instead.
     *
     * @param annotationType  The rule annotation type that requires a data adapter.
     * @param viewType  The {@link View} whose adapter we are looking for.
     *
