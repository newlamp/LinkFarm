...
/**
 * Grants access to information about other {@link View}s in the controller object.
 *
...
public class ValidationContext {
    ...
    /**
     * Retrieves all {@link View}s that are annotated with the specified annotation.
     *
     * @param saripaarAnnotation  The annotation we are interested in.
     *
     * @return A {@link List} of {@link View}s annotated with the
     *      given annotation.
     */
    ...
    /**
     * Retrieves the data from the given {@link View} using the appropriate
     * {@link com.mobsandgeeks.saripaar.adapter.ViewDataAdapter}.
     *
     * @param view  A {@link View}.
     * @param saripaarAnnotation  The annotation used to annotate the {@link View}.
     *
     * @return The data that's on the {@link View}.
     */
